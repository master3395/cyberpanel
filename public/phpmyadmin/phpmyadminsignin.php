...
try {
    ...
    // CyberPanel databases.js opens this URL with GET ?username=&token=
    // Older flows may POST the same fields. Accept both.
    $token = '';
    $username = '';
    if (isset($_POST['token']) || isset($_GET['token'])) {
        ...
        echo '<noscript><p>JavaScript required. <button type="submit" form="redirectForm">Continue</button></p></noscript>';
        echo '</body></html>';
        ...
        // No token/password: send user back to CyberPanel phpMyAdmin entry
